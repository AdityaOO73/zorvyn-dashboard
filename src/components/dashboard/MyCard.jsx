...
export default function MyCard() {
  ...
  return (
    <div
      className="p-4 sm:p-5 rounded-2xl space-y-4 w-full"
    ...
    >
      ...
      <div className="relative h-40 sm:h-44">
        ...
        >
          <div className="flex justify-between items-center">
            <div className="text-xs sm:text-sm opacity-80">Debit Card</div>
            <div className="w-8 sm:w-10 h-6 sm:h-7 bg-yellow-300 rounded-md" />
          </div>

          <div className="tracking-widest text-sm sm:text-lg font-semibold">
            1234 5678 9012 3456
          </div>
          ...
          <div className="flex justify-between items-center text-[10px] sm:text-sm">
            ...
            <div className="text-sm sm:text-xl font-bold">VISA</div>
          </div>
        </div>
      </div>
    </div>
